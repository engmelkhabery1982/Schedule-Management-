...
export function getInitialSeedData(): Record<string, any[]> {
  ...
  const projectBaselines: ProjectBaseline[] = [
    { id: 'bsl-p1-01', project_id: p1Id, name: 'خط الأساس المعتمد تعاقدياً (Target 1 - Rev 0)', is_active: true, status: 'approved', created_at: now },
    { id: 'bsl-p2-01', project_id: p2Id, name: 'خط الأساس المعتمد تعاقدياً لطريق الشرقية (Target 1 - Rev 0)', is_active: true, status: 'approved', created_at: now },
    { id: 'bsl-p3-01', project_id: p3Id, name: 'خط الأساس المعتمد لمستشفى جدة (Target 1 - Rev 0)', is_active: true, status: 'approved', created_at: now },
    { id: 'bsl-p4-01', project_id: p4Id, name: 'خط الأساس المعتمد لمجمع الفلل (Target 1 - Rev 0)', is_active: true, status: 'approved', created_at: now },
  ];
