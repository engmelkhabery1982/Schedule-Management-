...
export const translations: Record<Language, TranslationDictionary> = {
  ar: {
    ...
    total_progress: 'الإنجاز المكتسب للمشروع (EV / BAC)',
    ...
    forecast_finish: 'التسليم المتوقع (اتجاه SPI + المخاطر)',
    ...
    diff_title: 'مقارنة خط الأساس المعتمد بالجدول الحي (Schedule Diff & Baseline Variance)',
    diff_subtitle: 'قارن خط الأساس النشط والمعتمد بالجدول الحي لهذا المشروع لرصد الانحرافات الفعلية.',
    rev_a_label: 'المصدر المعتمد:',
    rev_b_label: 'الجدول الحالي:',
  ...
  en: {
    ...
    total_progress: 'Earned Progress (EV / BAC)',
    ...
    forecast_finish: 'Forecast Completion (SPI trend + risk)',
    ...
    diff_title: 'Approved Baseline vs Live Schedule',
    diff_subtitle: 'Compare this project’s active approved baseline with its live schedule using recorded data only.',
    rev_a_label: 'Approved source:',
    rev_b_label: 'Current schedule:',
